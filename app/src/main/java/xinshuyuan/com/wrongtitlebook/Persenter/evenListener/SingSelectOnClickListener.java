...
public class SingSelectOnClickListener implements View.OnClickListener {
    ...
    public SingSelectOnClickListener(ExerciseSelsctFragment exerciseSelsctFragment, Long testId, ExerciseHandler exerciseHandler ) {
...
//				System.out.println("组合完成");
                    ...
                    //试题id
                    commitmap.put(GlobalVarDefine.PARAM_TESTID,testId.toString());
                    //提交试题的json数据
