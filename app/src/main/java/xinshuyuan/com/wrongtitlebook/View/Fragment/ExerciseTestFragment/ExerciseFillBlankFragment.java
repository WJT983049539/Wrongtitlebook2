...
import xinshuyuan.com.wrongtitlebook.Model.Common.FillBlankJSInterface;
...
import xinshuyuan.com.wrongtitlebook.Model.CustomView.KeyBord.KeyboardUtil;
...
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.FillBlankOnClickListener;
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.FillBlankOnFocusListener;
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.FillBlankOnTouchListener;
...
public class ExerciseFillBlankFragment extends BaseFragment {
    ...
    public ExerciseFillBlankFragment(ExerciseHandler exerciseHandler, ExerciseTestActivity exerciseTestActivity) {
        super();
    ...
    private void initView() {
        ...
        if (ib != null) {
            ib.setOnClickListener(new FillBlankOnClickListener(this,exerciseHandler));
