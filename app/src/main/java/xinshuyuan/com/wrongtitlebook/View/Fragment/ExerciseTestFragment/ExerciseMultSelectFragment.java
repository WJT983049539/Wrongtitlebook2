...
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.MultiSelectOnClickListener;
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.MultiSelectOptionClickListener;
...
public class ExerciseMultSelectFragment extends BaseFragment {
    ...
    public ExerciseMultSelectFragment(ExerciseHandler exerciseHandler, ExerciseTestActivity exerciseTestActivity) {
         super();
    ...
    private void initView(){
        ...
        if(ib!=null){
            ib.setOnClickListener(new MultiSelectOnClickListener(this,exerciseHandler));
