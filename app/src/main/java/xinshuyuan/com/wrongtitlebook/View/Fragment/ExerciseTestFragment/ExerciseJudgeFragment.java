...
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.JudgeOnClickListener;
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.JudgeOptionClickListener;
...
public class ExerciseJudgeFragment extends BaseFragment {
    ...
    public ExerciseJudgeFragment(ExerciseHandler exerciseHandler, ExerciseTestActivity exerciseTestActivity) {
        super();
...
//					 uri_dialog.show();
    ...
    private void initView() {
        ...
        if(ib!=null){
            ib.setOnClickListener(new JudgeOnClickListener(this,exerciseHandler));
