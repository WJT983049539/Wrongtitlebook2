...
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.IncludeSubMultiSelectOptionClickListener;
...
public class ExerciseMultiSelectLayout extends IncludeLinearLayout {
    ...
    public ExerciseMultiSelectLayout(Context context, ExerciseNESTFragment includeFragment) {
        super(context);
