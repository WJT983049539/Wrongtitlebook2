 ...
 *
 */
public class YesOrNoSelectLayout extends IncludeLinearLayout {
	/*
	...
	public YesOrNoSelectLayout(Context context, IncludeFragment includeFragment) {
		super(context);
	...
	private void initMainLayout(){
		...
		LayoutParams lps1=new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
		lps1.leftMargin=30;
