...
import xinshuyuan.com.wrongtitlebook.Persenter.evenListener.IncludeSubYesOrNoSelectOptionClickListener;
...
public class ExerciseYesOrNoSelectLayout extends IncludeLinearLayout {
    /*
    ...
    public ExerciseYesOrNoSelectLayout(Context context, ExerciseNESTFragment includeFragment) {
        super(context);
