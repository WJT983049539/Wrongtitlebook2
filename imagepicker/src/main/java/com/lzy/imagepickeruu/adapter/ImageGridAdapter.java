...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            convertView = LayoutInflater.from(mActivity).inflate(com.lzy.imagepickeruu.R.layout.adapter_camera_item, parent, false);
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mActivity).inflate(com.lzy.imagepickeruu.R.layout.adapter_image_list_item, parent, false);
                convertView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mImageSize)); //让图片是个正方形
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            rootView = view;
            ivThumb = (ImageView) view.findViewById(com.lzy.imagepickeruu.R.id.iv_thumb);
            mask = view.findViewById(com.lzy.imagepickeruu.R.id.mask);
            cbCheck = (SuperCheckBox) view.findViewById(com.lzy.imagepickeruu.R.id.cb_check);
        }
    }
