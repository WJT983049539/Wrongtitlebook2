package com.lzy.imagepickeruu.adapter;
...
import com.lzy.imagepickeruu.ui.ImageBaseActivity;
...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_CAMERA){
            return new CameraViewHolder(mInflater.inflate(com.lzy.imagepickeruu.R.layout.adapter_camera_item,parent,false));
        }
        return new ImageViewHolder(mInflater.inflate(com.lzy.imagepickeruu.R.layout.adapter_image_list_item,parent,false));
    }
    ...
    private class ImageViewHolder extends ViewHolder{
        ...
        ImageViewHolder(View itemView) {
            super(itemView);
            rootView = itemView;
            ivThumb = (ImageView) itemView.findViewById(com.lzy.imagepickeruu.R.id.iv_thumb);
            mask = itemView.findViewById(com.lzy.imagepickeruu.R.id.mask);
            cbCheck = (SuperCheckBox) itemView.findViewById(com.lzy.imagepickeruu.R.id.cb_check);
            ...
            cbCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (cbCheck.isChecked() && mSelectedImages.size() >= selectLimit) {
                        Toast.makeText(mActivity.getApplicationContext(), mActivity.getString(com.lzy.imagepickeruu.R.string.select_limit, selectLimit), Toast.LENGTH_SHORT).show();
