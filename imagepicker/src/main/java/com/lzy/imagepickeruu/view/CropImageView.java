package com.lzy.imagepickeruu.view;
...
public class CropImageView extends AppCompatImageView {
    ...
    public CropImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.lzy.imagepickeruu.R.styleable.CropImageView);
        mMaskColor = a.getColor(com.lzy.imagepickeruu.R.styleable.CropImageView_cropMaskColor, mMaskColor);
        mBorderColor = a.getColor(com.lzy.imagepickeruu.R.styleable.CropImageView_cropBorderColor, mBorderColor);
        mBorderWidth = a.getDimensionPixelSize(com.lzy.imagepickeruu.R.styleable.CropImageView_cropBorderWidth, mBorderWidth);
        mFocusWidth = a.getDimensionPixelSize(com.lzy.imagepickeruu.R.styleable.CropImageView_cropFocusWidth, mFocusWidth);
        mFocusHeight = a.getDimensionPixelSize(com.lzy.imagepickeruu.R.styleable.CropImageView_cropFocusHeight, mFocusHeight);
        mDefaultStyleIndex = a.getInteger(com.lzy.imagepickeruu.R.styleable.CropImageView_cropStyle, mDefaultStyleIndex);
