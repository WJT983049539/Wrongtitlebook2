...
public class FolderPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public FolderPopUpWindow(Context context, BaseAdapter adapter) {
        ...
        final View view = View.inflate(context, com.lzy.imagepickeruu.R.layout.pop_folder, null);
        masker = view.findViewById(com.lzy.imagepickeruu.R.id.masker);
        masker.setOnClickListener(this);
        marginView = view.findViewById(com.lzy.imagepickeruu.R.id.margin);
        marginView.setOnClickListener(this);
        listView = (ListView) view.findViewById(com.lzy.imagepickeruu.R.id.listView);
