...
import com.lzy.imagepickeruu.DataHolder;
import com.lzy.imagepickeruu.ImageDataSource;
import com.lzy.imagepickeruu.ImagePicker;
import com.lzy.imagepickeruu.adapter.ImageFolderAdapter;
import com.lzy.imagepickeruu.adapter.ImageRecyclerAdapter;
import com.lzy.imagepickeruu.adapter.ImageRecyclerAdapter.OnImageItemClickListener;
import com.lzy.imagepickeruu.bean.ImageFolder;
import com.lzy.imagepickeruu.bean.ImageItem;
import com.lzy.imagepickeruu.view.FolderPopUpWindow;
...
//    private ImageGridAdapter mImageGridAdapter;  //图片九宫格展示的适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lzy.imagepickeruu.R.layout.activity_image_grid);
        ...
        mRecyclerView = (RecyclerView) findViewById(com.lzy.imagepickeruu.R.id.recycler);


        findViewById(com.lzy.imagepickeruu.R.id.btn_back).setOnClickListener(this);
        mBtnOk = (Button) findViewById(com.lzy.imagepickeruu.R.id.btn_ok);
        mBtnOk.setOnClickListener(this);
        mBtnDir = (Button) findViewById(com.lzy.imagepickeruu.R.id.btn_dir);
        mBtnDir.setOnClickListener(this);
        mBtnPre = (Button) findViewById(com.lzy.imagepickeruu.R.id.btn_preview);
        mBtnPre.setOnClickListener(this);
        mGridView = (GridView) findViewById(com.lzy.imagepickeruu.R.id.gridview);
        mFooterBar = findViewById(com.lzy.imagepickeruu.R.id.footer_bar);
...
//        mImageGridAdapter = new ImageGridAdapter(this, null);
    ...
    public void onClick(View v) {
        ...
        if (id == com.lzy.imagepickeruu.R.id.btn_ok) {
            ...
            finish();
        } else if (id == com.lzy.imagepickeruu.R.id.btn_dir) {
        ...
        } else if (id == com.lzy.imagepickeruu.R.id.btn_preview) {
...
//            intent.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS, imagePicker.getCurrentImageFolderItems());
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        ...
        mBtnPre.setText(getResources().getString(com.lzy.imagepickeruu.R.string.preview_count, imagePicker.getSelectImageCount()));
