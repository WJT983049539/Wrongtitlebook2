...
import com.lzy.imagepickeruu.util.BitmapUtil;
...
public class ImageCropActivity extends ImageBaseActivity implements View.OnClickListener, CropImageView.OnBitmapSaveCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lzy.imagepickeruu.R.layout.activity_image_crop);

        imagePicker = ImagePicker.getInstance();

        //初始化View
        findViewById(com.lzy.imagepickeruu.R.id.btn_back).setOnClickListener(this);
        Button btn_ok = (Button) findViewById(com.lzy.imagepickeruu.R.id.btn_ok);
        btn_ok.setText(getString(com.lzy.imagepickeruu.R.string.complete));
        btn_ok.setOnClickListener(this);
        TextView tv_des = (TextView) findViewById(com.lzy.imagepickeruu.R.id.tv_des);
        tv_des.setText(getString(com.lzy.imagepickeruu.R.string.photo_crop));
        mCropImageView = (CropImageView) findViewById(com.lzy.imagepickeruu.R.id.cv_crop_image);
...
//        mCropImageView.setImageURI(Uri.fromFile(new File(imagePath)));
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.lzy.imagepickeruu.R.id.btn_back) {
            setResult(RESULT_CANCELED);
            finish();
        } else if (id == com.lzy.imagepickeruu.R.id.btn_ok) {
