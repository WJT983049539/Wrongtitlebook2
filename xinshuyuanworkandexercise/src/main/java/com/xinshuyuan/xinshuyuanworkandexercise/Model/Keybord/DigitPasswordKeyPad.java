...
public class DigitPasswordKeyPad  extends View {
    ...
    private class DigitPasswordKeypadOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            } else if (viewId == R.id.btn_yiersan) {
            ...
            } else if (viewId == R.id.btn_dengyu) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "=";
            ...
            } else if (viewId == R.id.btn_nodengyu) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "≠";
            ...
            } else if (viewId == R.id.btn_gantai) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "!";
            ...
            } else if (viewId == R.id.btn_cuohao) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "×";
            ...
            } else if (viewId == R.id.btn_xinghao) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "*";
            ...
            } else if (viewId == R.id.btn_jianghao) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "#";
            ...
            } else if (viewId == R.id.btn_baifenhao) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "%";
            ...
            } else if (viewId == R.id.btn_yinhao) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += ":";
            ...
            } else if (viewId == R.id.btn_fenhao) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += ";";
            ...
            } else if (viewId == R.id.btn_wenhao) {
                if (digitnum.length() == length) {
                    return;
                } else {
                    digitnum += "?";
...
//            	}
            ...
            } else if (viewId == R.id.btn_shanchu) {
                if (digitnum.length() == 0) {
                    digitnum = "";
                }
//            	else{
...
//            	}
            ...
            } else if (viewId == R.id.btn_huitui) {
                if (digitnum.length() == 0) {
                    digitnum = "";
                }
//            	else{
