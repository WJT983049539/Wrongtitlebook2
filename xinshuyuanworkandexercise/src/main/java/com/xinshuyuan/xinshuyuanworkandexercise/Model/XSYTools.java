...
//    }
     ...
     * @return
     */
    public static String WorkJoinUrl(String url){
        String Ip=ConfigUtil.getIp();
        String Port=ConfigUtil.getPort();
        String basePath="http://"+Ip+":"+Port+"/"+"HAP"+"/";
            return basePath+url;
...
//    }
    ...
    //得到作业系统的Url
    public static String getNowWorkSystemUrl(Context context) {
        String nowurl="";
    ...
    //得到错题系统的Url
    public static String getWrongSystemUrl(Context context) {
        String nowurl="";
        PerferenceService service=new PerferenceService(context);
        nowurl=service.getsharedPre().getString("WrongUrl","");
        return nowurl;
    }
    //得到综合素质评价系统的Url
    public static String getEvaluateSystemUrl(Context context){
        String nowurl="";
        PerferenceService service=new PerferenceService(context);
        nowurl=service.getsharedPre().getString("EvaluateSystemUrl","");
        return nowurl;
    ...
    //封装得到作业系统的url并返回
    public static String getWrongUrl(String sta,Context context){
        String nowurl="";
        nowurl=getWrongSystemUrl(context)+"/"+sta;
        return nowurl;
    }
    //封装得到作业系统的url并返回
    public static String getWorkUrl(String sta,Context context){
        String nowurl="";
        nowurl=getNowWorkSystemUrl(context)+"/"+sta;
        return nowurl;
    }
    //封装得到作业系统的url并返回
    public static String getEvaluateUrl(String sta,Context context){
        String nowurl="";
        nowurl=getEvaluateSystemUrl(context)+"/"+sta;
        return nowurl;
    }
}
