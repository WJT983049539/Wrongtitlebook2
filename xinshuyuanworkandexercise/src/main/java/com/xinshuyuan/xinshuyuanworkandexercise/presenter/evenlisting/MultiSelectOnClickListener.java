...
public class MultiSelectOnClickListener implements View.OnClickListener {
    ...
    public MultiSelectOnClickListener(WorkExerciseMultSelectFragment exerciseMultSelectFragment, Handler exerciseHandler, String model) {
        fragment=exerciseMultSelectFragment;
    ...
    public void onClick(View v) {
        ...
        if(map!=null && map.size()>0){
            ...
            Integer itemType=fragment.getItemType();
