...
import com.xinshuyuan.xinshuyuanworkandexercise.presenter.evenlisting.MultiSelectOnClickListener;
import com.xinshuyuan.xinshuyuanworkandexercise.presenter.evenlisting.MultiSelectOptionClickListener;
...
public class WorkExerciseMultSelectFragment extends BaseFragment {
    ...
    public WorkExerciseMultSelectFragment(Handler exerciseHandler, Activity exerciseTestActivity) {
         super();
    ...
    public WorkExerciseMultSelectFragment(){}
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView= inflater.inflate(R.layout.layout_exercise_multiselect, container,false);
        try {
            initTest();
            initView();
    ...
    private void initView(){
        ImageButton ib=this.getViewById(mView,R.id.multiselect_submit_btn);
        if(ib!=null){
            ib.setOnClickListener(new MultiSelectOnClickListener(this,exerciseHandler,Model));
