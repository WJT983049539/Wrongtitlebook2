...
import com.xinshuyuan.xinshuyuanworkandexercise.Model.javabean.answers;
...
import com.xinshuyuan.xinshuyuanworkandexercise.presenter.evenlisting.LineOnClickListener;
import com.xinshuyuan.xinshuyuanworkandexercise.presenter.evenlisting.LineXOnTouchListener;
import com.xinshuyuan.xinshuyuanworkandexercise.presenter.evenlisting.LineXiaoChuAllOnClickListener;
import com.xinshuyuan.xinshuyuanworkandexercise.presenter.evenlisting.LineXiaoChuOnClickListener;
...
public class WorkExerciseLineFragment extends BaseFragment {
    ...
    public WorkExerciseLineFragment(Handler exerciseHandler, Activity exerciseTestActivity) {
        this.exerciseHandler=exerciseHandler;
        this.exerciseTestActivity=exerciseTestActivity;
    }

    public WorkExerciseLineFragment(){}
    @Override
...
//    }
    ...
    private void initView() {
        ...
        if(ib!=null){
            ib.setOnClickListener(new LineOnClickListener(this,exerciseHandler,Model));
