...
import com.xinshuyuan.xinshuyuanworkandexercise.presenter.evenlisting.IncludeSubMultiSelectOptionClickListener;
...
public class WorkExerciseMultiSelectLayout extends IncludeLinearLayout {
    ...
    public WorkExerciseMultiSelectLayout(Context context, WorkExerciseNESTFragment includeFragment) {
        super(context);
    ...
    private void initOptions() throws JSONException{
        ...
        for(AnswerEntity ans:ansList){
            ...
            btn.setOnClickListener(new IncludeSubMultiSelectOptionClickListener(this));
