...
public class WorkExerciseSingleSelectLayout extends IncludeLinearLayout {
    /*
    ...
    public WorkExerciseSingleSelectLayout(Context context, WorkExerciseNESTFragment includeFragment1) {
        super(context);
