...
import com.xinshuyuan.xinshuyuanworkandexercise.Model.TestListMenu;
...
public class Work_ShowtestListFragment extends Fragment{
    ...
    private Handler showWrongHandler;
    //题型
    private Integer TestType;
    //展示题型
    private String StringTestType;
    //把要显示的错题列表储存起来
    List<TestListMenu> testList = new ArrayList<TestListMenu>();
    //题干
        ...
        if (!((Value.equals("")||Value==null))) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    TestListMenu wlm = new TestListMenu();

                    Integer type = object.getInt("itemType");
                    String title = object.getString("itemPoint");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        wrong_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Long TestId = testList.get(position).getTestId();
                //获取单个详细信息的url
                ...
                testoInfoMap.put(HomeWorkConstantClass.PARAM_STUWORKID,"0");
                OkGo.post(getWrongQuestionInfoUrl).params(testoInfoMap).execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        showWrongHandler.sendMessage(XSYTools.makeNewMessage(Common.PRIVIEW_SHOW_TEXT, testEntity));
     ...
     */
    public void setInfo(String obj, Handler showWrongHandler) {
        this.Value = obj;
    ...
    class ShowWrongAdapter extends BaseAdapter {
        ...
        public int getItemViewType(int position) {
            TestListMenu wrongMenu = testList.get(position);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final String Title=testList.get(position).getTitle();
            Integer testType=testList.get(position).getTestType();
                                ...
                                OkGo.post(getWrongQuestionInfoUrl).params(testoInfoMap).execute(new StringCallback() {
                                    ...
                                    public void onSuccess(String s, Call call, Response response) {
                                        ...
                                        try {
                                            ...
                                            Integer TestType2 = object2.getInt("itemType");
                                            //得到题干
                                            String point2 = object2.getString("itemPoint");
                                            //试题id
                                            long testId2=object2.getLong("id");
                                            String answerAnalysis2=object2.getString("answerAnalysis");
                                            String Subject2=object2.getString("subjectName");
                                            //装入javabean
                                            testEntity =new TestEntity();
                                            testEntity.setTestId(testId2);
                                            testEntity.setTestType(TestType2);
                                            testEntity.setPoint(point2);
                                            testEntity.setSubject(Subject2);
                                            testEntity.setAnswerAnalysis(answerAnalysis2);
                                            JSONArray jsonarray2 = object2.getJSONArray("answerList");
                                            for (int i = 0; i < jsonarray2.length(); i++) {
                                                JSONObject obb = jsonarray2.getJSONObject(i);
                                                long answerid2 = obb.getLong("id");
                                                long answertestId2 = obb.getLong("testId");
                                                String optionTitle2 = obb.getString("optionTitle");
                                                String optionAnswer2 = obb.getString("optionAnswer");
                                                Boolean isRealAnswer2 = obb.getBoolean("isRealAnswer");

                                                AnswerEntity answerEntity = new AnswerEntity();
                                                answerEntity.setId(answerid2);
                                                answerEntity.setTestId(answertestId2);
                                                answerEntity.setIsRealAnswer(isRealAnswer2);
                                                answerEntity.setOptionAnswer(optionAnswer2);
                                                answerEntity.setOptionTitle(optionTitle2);
                                                testEntity.fillAnser(answerEntity);
                                            }
