...
public class WorkOnlyAnswerFragment extends BaseFragment {
    private View Mview;
    ...
    private String UserId="";
        ...
        public WorkOnlyAnswerFragment(){}


    public WorkOnlyAnswerFragment(Handler layering_practiceHandler, Activity layering_practice_activity,String flagg) {
        super();
        this.exerciseHandler=layering_practiceHandler;
...
//        Model=flagg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        Mview=inflater.inflate(R.layout.work_layout_answer_only,container,false);
        inint();
        return Mview;
    ...
    private void inint() {
        ans_no_jiexi= (TextView) Mview.findViewById(R.id.ans_only_jiexi);
        ans_no_jiexi.setText(answerAnalysis);
        answer_no_return_button= (Button) Mview.findViewById(R.id.answer_only_return_button);
        answer_no_come_onbutton=(Button) Mview.findViewById(R.id.answer_only_come_onbutton);
        //结束答题
